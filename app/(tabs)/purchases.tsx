      ...
      {tab === "orders" ? (
        <>
          ...
          <ScrollView
            ...
            contentContainerStyle={[styles.list, { paddingBottom: botPad + 20 }, layout.isWide && { maxWidth: layout.maxContentWidth, alignSelf: "center" as const, width: "100%" }]}
          >
        ...
        <>
          <ScrollView
            style={{ flex: 1 }}
            showsVerticalScrollIndicator={false}
            contentContainerStyle={[styles.list, { paddingBottom: botPad + 80 }, layout.isWide && { maxWidth: layout.maxContentWidth, alignSelf: "center" as const, width: "100%" }]}
          >
            {suppliers.map((s) => (
              <SupplierCard
                key={s.id}
