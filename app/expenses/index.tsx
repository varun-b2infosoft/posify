...
export default function ExpensesScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={[{ padding: 12, gap: 8, paddingBottom: botPad + 24 }, layout.isWide && { maxWidth: layout.maxContentWidth, alignSelf: "center" as const, width: "100%" }]}>
        {filtered.length === 0 && (
